# Generated by Django 3.2.10 on 2022-06-06 08:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('age_limit', models.CharField(choices=[('All', 'All'), ('kids', 'kids')], max_length=10)),
                ('videos', models.ManyToManyField(to='webite.video')),
            ],
        ),
        migrations.CreateModel(
            name='CustomUser',
            fields=[
                ...
                ('profiles', models.ManyToManyField(blank=True, to='webite.Profile')),
